...
export default function ResumePage() {
  return (
    <main className="mx-auto min-h-screen w-full max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto mb-8 flex w-full max-w-4xl flex-col items-center gap-6 text-center lg:mb-10">
        <div className="max-w-3xl">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white sm:text-4xl">Quan Zhang</h1>
          <p className="mt-2 text-base font-medium text-gray-700 dark:text-white/80">Front-End / Full-Stack Developer</p>
          <p className="mt-3 text-sm leading-7 text-gray-600 dark:text-white/70 sm:text-base">
            Melbourne, VIC | (+61) 0435 892 531 | quanzhang886@gmail.com
          </p>
          <p className="mt-1 text-sm leading-7 text-gray-600 dark:text-white/70 sm:text-base">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Link
            ...
            className="rounded-full bg-gray-900 px-5 py-3 text-sm font-medium text-white transition hover:bg-gray-800 sm:text-base"
          >
            Download PDF Resume
          </Link>
          <Link
            href="/"
            className="rounded-full border border-black/10 bg-white px-5 py-3 text-sm font-medium text-gray-900 transition hover:bg-gray-50 dark:bg-white/10 dark:text-white sm:text-base"
          >
            Back to Portfolio
          </Link>
        </div>
      ...
      <section className="mx-auto mb-8 w-full max-w-4xl rounded-2xl border border-black/5 bg-white p-5 shadow-sm dark:bg-white/5 sm:p-6">
      ...
      <section className="mx-auto w-full max-w-4xl rounded-2xl border border-black/5 bg-white p-5 shadow-sm dark:bg-white/5 sm:p-6">
