    ...
    >
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/quan-zhang-b58032268/"
          target={"_blank"}
        >
          <BsLinkedin />
        </a>
        <a
          className="bg-white px-7 py-3 flex items-center gap-2 rounded-full text-[1.35rem] ounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
